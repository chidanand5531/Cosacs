...
public class Xpath {
	...
	public static class Vendor_Creation {
		...
		public static String Contact_ArrowMark2="(//div[@class='list-container ng-scope']//i[@class='glyphicons play'])[2]";
		...
		public static String Delete_Contact="(//div[@class='control-label']//a[@title='Remove'])[2]";
	...
	public static class TopskuReports {
		...
		public static String ExportBTN = "//div[@class='pull-right']//button[text()='Export']";
		public static String ClearBTN = "//div[@class='pull-right']//button[text()='Clear']";
