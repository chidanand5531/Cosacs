...
public class COS20_HomeDelivery extends BaseClass{
	...
	public static String PickedByEmp="Judith Cohen";
	public static String CheckedEmp="Judith Cohen";
	public static String comment="Item Picked and Checked Successfully";
	public static String SendingLocation="171 LUCKY DOLLAR MAY PEN";
	public static String ExpectedSearchShipmentPageTitle="Search Shipments";
	public static String DeleveryBranch="171 LUCKY DOLLAR MAY PEN";
	...
	public static String Truck="CARLTON THOMAS";
...
@Test(dependsOnMethods="Picking")
	public void SearchPicklist()throws Exception
	{
		try
		{
			...
			Thread.sleep(3000);
			Library.Interaction.userWait();
			String PickingStatus =driver.findElement(By.xpath(Xpath.SearchPickList.PickingRejectionStaus)).getText();
	...
	public void SearchShipments() throws Exception
	{
		try
		{
			...
			Thread.sleep(2000);
			Library.Interaction.userWait();
			String ShipmentStatus = driver.findElement(By.xpath(Xpath.SearchShipments.SearchShimpmentStatus)).getText();
